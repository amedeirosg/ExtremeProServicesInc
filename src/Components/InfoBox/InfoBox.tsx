...
export default (props: {sourceImg:any, serviceTitle:any, desc1:any, desc2:any,desc3:any,desc4:any,desc5:any,desc6:any,desc7:any, desc8:any}) => {

    return <div className="containerBoxesContent">

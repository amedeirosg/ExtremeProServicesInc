function SvgComponent(props: any) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M113 446c24.8 0 45.1-20.2 45.1-45.1 0-9.8-3.2-18.9-8.5-26.3-8.2-11.3-21.5-18.8-36.5-18.8s-28.3 7.4-36.5 18.8c-5.3 7.4-8.5 16.5-8.5 26.3C68 425.8 88.2 446 113 446z" />
      <path d="M211.4 345.9L211.4 308.1 211.4 302.5 205.8 302.5 168 302.6 168.2 346z" />
